...
int today(string const& s)
{
	int const day[] = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
...
{
	int a1 = today(arriveAlice), a2 = today(leaveAlice) + 1;
	int b1 = today(arriveBob), b2 = today(leaveBob) + 1;
	return max(0, min(a2, b2) - max(a1, b1));
}

int main()
{
	ToOut(countDaysTogether("08-15", "08-18", "08-16", "08-19"));
	ToOut(countDaysTogether("10-01", "10-31", "11-01", "12-31"));
}
